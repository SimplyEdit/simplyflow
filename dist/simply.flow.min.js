(()=>{var he=Object.defineProperty;var G=(e,t)=>{for(var n in t)he(e,n,{get:t[n],enumerable:!0})};var F={};G(F,{batch:()=>$,clockEffect:()=>Z,destroy:()=>q,effect:()=>Y,signal:()=>E,throttledEffect:()=>y,trace:()=>be,untracked:()=>we});var I=Symbol("iterate");Symbol.xRay||(Symbol.xRay=Symbol("xRay"));Symbol.Signal||(Symbol.Signal=Symbol("Signal"));var me={get:(e,t,n)=>{if(t===Symbol.xRay)return e;if(t===Symbol.Signal)return!0;let i=e?.[t];return R(n,t),typeof i=="function"?Array.isArray(e)?(...r)=>{let l=e.length,s=i.apply(n,r);return l!=e.length&&A(n,w("length",{was:l,now:e.length})),s}:e instanceof Set||e instanceof Map?(...r)=>{let l=e.size,s=i.apply(e,r);return l!=e.size&&A(n,w("size",{was:l,now:e.size})),["set","add","clear","delete"].includes(t)&&A(n,w({entries:{},forEach:{},has:{},keys:{},values:{},[Symbol.iterator]:{}})),s}:e instanceof HTMLElement||e instanceof Number||e instanceof String||e instanceof Boolean?i.bind(e):i.bind(n):i&&typeof i=="object"?E(i):i},set:(e,t,n,i)=>{n=n?.[Symbol.xRay]||n;let r=e[t];return r!==n&&(e[t]=n,A(i,w(t,{was:r,now:n}))),typeof r>"u"&&A(i,w(I,{})),!0},has:(e,t)=>{let n=m.get(e);return n&&R(n,t),Object.hasOwn(e,t)},deleteProperty:(e,t)=>{if(typeof e[t]<"u"){let n=e[t];delete e[t];let i=m.get(e);A(i,w(t,{delete:!0,was:n}))}return!0},defineProperty:(e,t,n)=>{if(typeof e[t]>"u"){let i=m.get(e);A(i,w(I,{}))}return Object.defineProperty(e,t,n)},ownKeys:e=>{let t=m.get(e);return R(t,I),Reflect.ownKeys(e)}},m=new WeakMap;function E(e){if(e[Symbol.Signal]){let t=e[Symbol.xRay];m.has(t)||m.set(t,e),e=t}else m.has(e)||m.set(e,new Proxy(e,me));return m.get(e)}function be(e,t){return X(e,t).map(i=>({effect:i.effectType,fn:i.effectFunction,signal:m.get(i.effectFunction)}))}var j=new Set,v=0;function A(e,t={}){let n=[];if(t.forEach((i,r)=>{let l=X(e,r);if(l?.length){for(let s of l)ge(s,w(r,i));n=n.concat(l)}}),n=new Set(n.filter(Boolean)),n)if(v)j=j.union(n);else{let i=p[p.length-1];for(let r of Array.from(n))r!=i&&r?.needsUpdate&&r(),Q(r)}}function w(e,t){let n=new Map;if(typeof e=="object")for(let i in e)n.set(i,e[i]);else n.set(e,t);return n}function ge(e,t){e.context?t.forEach((n,i)=>{e.context.set(i,n)}):e.context=t,e.needsUpdate=!0}function Q(e){delete e.context,delete e.needsUpdate}function R(e,t){let n=p[p.length-1];n&&ye(e,t,n)}var M=new WeakMap,C=new WeakMap;function X(e,t){let n=M.get(e);return n?Array.from(n.get(t)||[]):[]}function ye(e,t,n){M.has(e)||M.set(e,new Map);let i=M.get(e);i.has(t)||i.set(t,new Set),i.get(t).add(n),C.has(n)||C.set(n,new Map);let r=C.get(n);r.has(t)||r.set(t,new Set),r.get(t).add(e)}function N(e){let t=C.get(e);t&&t.forEach(n=>{n.forEach(i=>{let r=M.get(i);r.has(n)&&r.get(n).delete(e)})})}var p=[],P=[],z=new WeakMap,S=[];function Y(e){if(P.findIndex(i=>e==i)!==-1)throw new Error("Recursive update() call",{cause:e});P.push(e);let t=m.get(e);t||(t=E({current:null}),m.set(e,t));let n=function i(){if(S.findIndex(l=>l==t)!==-1)throw new Error("Cyclical dependency in update() call",{cause:e});N(i),i.effectFunction=e,i.effectType=Y,p.push(i),S.push(t);let r;try{r=e(i,p,S)}finally{p.pop(),S.pop(),r instanceof Promise?r.then(l=>{t.current=l}):t.current=r}};return n.fn=e,z.set(t,n),n(),t}function q(e){let t=z.get(e)?.deref();if(!t)return;N(t);let n=t.fn;m.remove(n),z.delete(e)}function $(e){v++;let t;try{t=e()}finally{t instanceof Promise?t.then(()=>{v--,v||J()}):(v--,v||J())}return t}function J(){let e=Array.from(j);j=new Set;let t=p[p.length-1];for(let n of e)n!=t&&n?.needsUpdate&&n(),Q(n)}function y(e,t){if(P.findIndex(s=>e==s)!==-1)throw new Error("Recursive update() call",{cause:e});P.push(e);let n=m.get(e);n||(n=E({current:null}),m.set(e,n));let i=!1,r=!0;return function s(){if(S.findIndex(c=>c==n)!==-1)throw new Error("Cyclical dependency in update() call",{cause:e});if(i&&i>Date.now()){r=!0;return}N(s),s.effectFunction=e,s.effectType=y,p.push(s),S.push(n);let a;try{a=e(s,p,S)}finally{r=!1,p.pop(),S.pop(),a instanceof Promise?a.then(c=>{n.current=c}):n.current=a}i=Date.now()+t,globalThis.setTimeout(()=>{r&&s()},t)}(),n}function Z(e,t){let n=m.get(e);n||(n=E({current:null}),m.set(e,n));let i=-1,r=!0;return function s(){if(i<t.time)if(r){N(s),s.effectFunction=e,s.effectType=Z,p.push(s),i=t.time;let a;try{a=e(s,p)}finally{p.pop(),a instanceof Promise?a.then(c=>{n.current=c}):n.current=a,r=!1}}else i=t.time;else r=!0}(),n}function we(e){let t=p.slice();p=[];try{return e()}finally{p=t}}function x(e,t){let n=e.value?.innerHTML;typeof e.value=="string"&&(n=e.value,e.value={innerHTML:n}),n&&(n=n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),e.value.innerHTML=n),t(e)}function ee(e,t){typeof e.value=="string"?e.value={}:delete e.value?.innerHTML,t(e)}function ne(e){if(e.templates?.length)Ee.call(this,e);else if(Object.hasOwnProperty.call(this.options.renderers,e.element.tagName)){let t=this.options.renderers[e.element.tagName];t&&t.call(this,e)}else this.options.renderers["*"]&&this.options.renderers["*"].call(this,e);return e}function ie(e){return Array.isArray(e.value)||(e.value=[e.value]),e.templates?.length?Se.call(this,e):console.error("No templates found in",e.element),e}function re(e){return typeof e.value!="object"||!e.value?console.error("Value is not an object.",e.element,e.path,e.value):e.templates?.length?Ae.call(this,e):console.error("No templates found in",e.element),e}function Se(e){let t=this.options.attribute,n=e.element.querySelectorAll(":scope > ["+t+"-key]"),i=0,r=0;e.list=e.value;for(let s of n){let a=parseInt(s.getAttribute(t+"-key"));if(a>i)e.index=i,e.element.insertBefore(this.applyTemplate(e),s);else if(a<i)s.remove();else{let c=Array.from(s.querySelectorAll(`[${t}]`));s.matches(`[${t}]`)&&c.unshift(s);let u=c.find(d=>{let b=d.getAttribute(t);return b.substr(0,5)!==":root"&&b.substr(0,e.path.length)!==e.path});if(!u&&s[Symbol.bindTemplate]){let d=this.findTemplate(e.templates,e.list[i]);d!=s[Symbol.bindTemplate]&&(u=!0,d||r++)}u&&(e.index=i,e.element.replaceChild(this.applyTemplate(e),s))}if(i++,i>=e.value.length)break}n=e.element.querySelectorAll(":scope > ["+t+"-key]");let l=n.length+r;if(l>e.value.length)for(;l>e.value.length;)e.element.querySelectorAll(":scope > :not(template)")?.[l-1]?.remove(),l--;else if(l<e.value.length)for(;l<e.value.length;)e.index=l,e.element.appendChild(this.applyTemplate(e)),l++}function Ae(e){let t=this.options.attribute;e.list=e.value;let n=Array.from(e.element.querySelectorAll(":scope > ["+t+"-key]"));for(let i in e.list){e.index=i;let r=n.shift();if(!r){let s=this.applyTemplate(e);e.element.appendChild(s);continue}if(r.getAttribute[t+"-key"]!=i){n.unshift(r);let s=e.element.querySelector(":scope > ["+t+'-key="'+i+'"]');if(s)e.element.insertBefore(s,r),r=s,n=n.filter(a=>a!=s);else{let a=this.applyTemplate(e);e.element.insertBefore(a,r);continue}}if(this.findTemplate(e.templates,e.list[e.index])!=r[Symbol.bindTemplate]){let s=this.applyTemplate(e);e.element.replaceChild(s,r)}}for(;n.length;)n.shift().remove()}function Ee(e){let t=e.element.querySelector(":scope > :not(template)"),n=this.findTemplate(e.templates,e.value);if(e.parent=Te(e.element),t)if(n){if(t?.[Symbol.bindTemplate]!=n){let i=this.applyTemplate(e);e.element.replaceChild(i,t)}}else e.element.removeChild(t);else if(n){let i=this.applyTemplate(e);e.element.appendChild(i)}}function Te(e,t){let n=e.parentElement?.closest(`[${t}-list],[${t}-map]`);return n?n.hasAttribute(`${t}-list`)?n.getAttribute(`${t}-list`)+".":n.getAttribute(`${t}-map`)+".":""}function se(e){let t=e.element,n=e.value;L(e),typeof n>"u"&&(n=""),t.type=="checkbox"||t.type=="radio"?H(t.value,n)?t.checked=!0:t.checked=!1:H(t.value,n)||(t.value=""+n)}function le(e){L(e),T(e.element,e.value,"value")}function U(e){let t=e.element,n=e.value;if(n===null&&(n=""),typeof n!="object")if(t.multiple){if(Array.isArray(n))for(let i of t.options)n.indexOf(i.value)===!1?i.selected=!1:i.selected=!0}else{let i=t.options.find(r=>H(r.value,n));i&&(i.selected=!0,i.setAttribute("selected",!0))}else n.options&&ve(t,n.options),n.selected&&U(Object.asssign({},e,{value:n.selected})),T(t,n,"name","id","selectedIndex","className")}function te(e,t){t&&(typeof t!="object"?e.options.add(new Option(""+t)):t.text?e.options.add(new Option(t.text,t.value,t.defaultSelected,t.selected)):typeof t.value<"u"&&e.options.add(new Option(""+t.value,t.value,t.defaultSelected,t.selected)))}function ve(e,t){if(e.innerHTML="",Array.isArray(t))for(let n of t)te(e,n);else if(t&&typeof t=="object")for(let n in t)te(e,{text:t[n],value:n})}function oe(e){L(e),T(e.element,e.value,"target","href","name","newwindow","nofollow")}function ae(e){T(e.element,e.value,"title","alt","src","id")}function fe(e){T(e.element,e.value,"title","src","id")}function ue(e){T(e.element,e.value,"content","id")}function L(e){let t=e.element,n=e.value;(typeof n>"u"||n==null)&&(n="");let i=""+n;if(typeof n!="object"||i.substring(0,8)!="[object "){t.innerHTML=i;return}T(t,n,"innerHTML","title","id","className")}function T(e,t,...n){if(!(!t||typeof t!="object"))for(let i of n)typeof t[i]>"u"||H(e[i],t[i])||(t[i]===null?e[i]="":e[i]=""+t[i])}function H(e,t){return e==":empty"&&!t||t==":empty"&&!e||""+e==""+t}Symbol.bindTemplate||(Symbol.bindTemplate=Symbol("bindTemplate"));var _=class{constructor(t){this.bindings=new Map;let n={escape_html:x,fixed_content:ee},i={container:document.body,attribute:"data-flow",transformers:n,render:{field:[ne],list:[ie],map:[re]},renderers:{INPUT:se,BUTTON:le,SELECT:U,A:oe,IMG:ae,IFRAME:fe,META:ue,TEMPLATE:null,"*":L}};if(!t?.root)throw new Error("bind needs at least options.root set");this.options=Object.assign({},i,t),t.transformers&&(this.options.transformers=Object.assign({},n,t?.transformers));let r=this.options.attribute,l=[r+"-field",r+"-list",r+"-map"],s=r+"-transform",a=o=>{let f=l.find(h=>o.hasAttribute(h));return f||console.error("No matching attribute found",o,l),f},c=o=>{this.bindings.set(o,y(()=>{if(!o.isConnected){Le(o,this.getBindingPath(o)),q(this.bindings.get(o));return}let f={templates:o.querySelectorAll(":scope > template"),attribute:a(o)};f.path=this.getBindingPath(o),f.value=W(this.options.root,f.path),f.element=o,Me(o,f),u(f)},50))},u=o=>{let f;switch(o.attribute){case this.options.attribute+"-field":f=Array.from(this.options.render.field);break;case this.options.attribute+"-list":f=Array.from(this.options.render.list);break;case this.options.attribute+"-map":f=Array.from(this.options.render.map);break;default:throw new Error("no valid context attribute specified",o)}o.element.hasAttribute(s)&&o.element.getAttribute(s).split(" ").filter(Boolean).forEach(g=>{this.options.transformers[g]?f.push(this.options.transformers[g]):console.warn("No transformer with name "+g+" configured",{cause:o.element})});let h;for(let g of f)h=((k,pe)=>de=>pe.call(this,de,k))(h,g);h(o)},d=o=>{for(let f of o)this.bindings.get(f)||c(f)},b=o=>{let f=`[${r}-field],[${r}-list],[${r}-map]`;for(let h of o)if(h.type=="childList"&&h.addedNodes){for(let g of h.addedNodes)if(g instanceof HTMLElement){let k=Array.from(g.querySelectorAll(f));g.matches(f)&&k.unshift(g),k.length&&d(k)}}};this.observer=new MutationObserver(o=>{b(o)}),this.observer.observe(this.options.container,{subtree:!0,childList:!0});let O=this.options.container.querySelectorAll(":is(["+this.options.attribute+"-field],["+this.options.attribute+"-list],["+this.options.attribute+"-map]):not(template)");O.length&&d(O)}applyTemplate(t){let n=t.path,i=t.parent,r=t.templates,l=t.list,s=t.index,a=l?l[s]:t.value,c=this.findTemplate(r,a);if(!c){let o=new DocumentFragment;return o.innerHTML="<!-- no matching template -->",o}let u=c.content.cloneNode(!0);if(!u.children?.length)return u;if(u.children.length>1)throw new Error("template must contain a single root node",{cause:c});let d=this.options.attribute,b=[d+"-field",d+"-list",d+"-map"],O=u.querySelectorAll(`[${d}-field],[${d}-list],[${d}-map]`);for(let o of O){if(o.tagName=="TEMPLATE")continue;let f=b.find(g=>o.hasAttribute(g)),h=o.getAttribute(f);h=this.applyLinks(c.links,h),h.substring(0,6)==":root."?o.setAttribute(f,h.substring(6)):h==":value"&&s!=null?o.setAttribute(f,n+"."+s):s!=null?o.setAttribute(f,n+"."+s+"."+h):o.setAttribute(f,i+h)}return typeof s<"u"&&u.children[0].setAttribute(d+"-key",s),u.children[0][Symbol.bindTemplate]=c,u}parseLinks(t){let n={};t=t.split(";").map(i=>i.trim());for(let i of t)i=i.split("="),n[i[0].trim()]=i[1].trim();return n}applyLinks(t,n){for(let i in t){if(n.startsWith(i+"."))return t[i]+n.substr(i.length);if(n==i)return t[i]}return n}getBindingPath(t){let n=[this.options.attribute+"-field",this.options.attribute+"-list",this.options.attribute+"-map"];for(let i of n)if(t.hasAttribute(i))return t.getAttribute(i)}findTemplate(t,n){let i=a=>{let c=this.getBindingPath(a),u;c?c.substr(0,6)==":root."?u=W(this.options.root,c):u=W(n,c):u=n;let d=""+u,b=a.getAttribute(this.options.attribute+"-match");if(b){if(b===":empty"&&!u)return a;if(b===":notempty"&&u||d==b)return a}if(!b&&u!==null&&u!==void 0)return a},r=Array.from(t).find(i),l=null;r?.hasAttribute(this.options.attribute+"-link")&&(l=this.parseLinks(r.getAttribute(this.options.attribute+"-link")));let s=r?.getAttribute("rel");if(s){let a=document.querySelector("template#"+s);if(!a)throw new Error("Could not find template with id "+s);r=a}return r&&(r.links=l),r}destroy(){this.bindings.forEach(t=>{q(t)}),this.bindings=new Map,this.observer.disconnect()}};function ce(e){return new _(e)}var B=new Map;function Me(e,t){B.has(t.path)?B.get(t.path).push(t):B.set(t.path,[t])}function Le(e,t){let n=B.get(t);n&&(n=n.filter(i=>i.element==e),B.set(t,n))}function W(e,t){let n=t.split("."),i=e,r;r=n.shift();let l=null;for(;r&&i;)r=decodeURIComponent(r),r=="0"&&!Array.isArray(i)||(r==":key"?i=l:r==":value"||(Array.isArray(i)&&typeof i[r]>"u"?i=i[0][r]:i=i[r])),l=r,r=n.shift();return i}var K={};G(K,{columns:()=>Pe,filter:()=>je,model:()=>Be,paging:()=>Ce,scroll:()=>Ne,sort:()=>Oe});var D=class{constructor(t){if(!t)throw new Error("no options set");(t.data==null||typeof t.data[Symbol.iterator]!="function")&&console.warn("SimplyFlowModel: options.data is not iterable"),this.state=E(t),this.state.options||(this.state.options={}),this.effects=[{current:this.state.data}],this.view={current:this.state.data}}addEffect(t){if(!t||typeof t!="function")throw new Error("addEffect requires an effect function as its parameter",{cause:t});let n=this.effects[this.effects.length-1],i=t.call(this,n);if(!i||!i[Symbol.Signal])throw new Error("addEffect function parameter must return a Signal",{cause:t});this.view=i,this.effects.push(this.view)}};function Be(e){return new D(e)}function Oe(e={}){return function(t){return this.state.options.sort=Object.assign({direction:"asc",sortBy:null,sortFn:(n,i)=>{let r=this.state.options.sort,l=r.sortBy;if(!r.sortBy)return 0;let s=r.direction=="asc"?1:-1,a=r.direction=="asc"?-1:1;return typeof n?.[l]>"u"?typeof i?.[l]>"u"?0:s:typeof i?.[l]>"u"||n[l]<i[l]?a:n[l]>i[l]?s:0}},e),y(()=>{let n=this.state.options.sort;return n?.sortBy&&n?.direction?t.current.toSorted(n?.sortFn):t.current},50)}}function Ce(e={}){return function(t){return this.state.options.paging=Object.assign({page:1,pageSize:20,max:1},e),y(()=>$(()=>{let n=this.state.options.paging;n.pageSize||(n.pageSize=20),n.max=Math.ceil(this.state.data.length/n.pageSize),n.page=Math.max(1,Math.min(n.max,n.page));let i=(n.page-1)*n.pageSize,r=i+n.pageSize;return t.current.slice(i,r)}),50)}}function je(e){if(!e?.name||typeof e.name!="string")throw new Error("filter requires options.name to be a string");if(!e.matches||typeof e.matches!="function")throw new Error("filter requires options.matches to be a function");return function(t){if(this.state.options[e.name])throw new Error("a filter with this name already exists on this model");return this.state.options[e.name]=e,y(()=>this.state.options[e.name].enabled?t.current.filter(this.state.options[e.name].matches.bind(this)):t.current,50)}}function Pe(e={}){if(!e||typeof e!="object"||Object.keys(e).length===0)throw new Error("columns requires options to be an object with at least one property");return function(t){return this.state.options.columns=e,y(()=>t.current.map(n=>{let i={};for(let r of Object.keys(this.state.options.columns))this.state.options.columns[r]?.hidden||(i[r]=n[r]);return i}),50)}}function Ne(e){return function(t){this.state.options.scroll=Object.assign({offset:0,rowHeight:26,rowCount:20,itemsPerRow:1,size:t.current.length},e);let n=this.state.options.scroll,i=n.scrollbar||n.container?.querySelector("[data-flow-scrollbar]");return i&&(n.container&&n.container.addEventListener("scroll",r=>{n.offset=Math.floor(n.container.scrollTop/(n.rowHeight*n.itemsPerRow))}),y(()=>{n.size=t.current.length*n.rowHeight,i.style.height=n.size+"px"},50)),y(()=>{n.container&&(n.rowCount=Math.ceil(n.container.getBoundingClientRect().height/n.rowHeight)),n.data=t.current;let r=Math.min(n.offset,t.current.length-1),l=r+n.rowCount;return l>t.current.length&&(l=t.current.length,r=l-n.rowCount),t.current.slice(r,l)},50)}}var V=class extends HTMLElement{constructor(){super()}connectedCallback(){let t=this.getAttribute("rel"),n=document.getElementById(t);if(n){let i=n.content.cloneNode(!0);for(let r of i.childNodes){let l=r.cloneNode(!0);if(l.nodeType==document.ELEMENT_NODE&&(l.querySelectorAll("template").forEach(function(s){s.setAttribute("simply-render","")}),this.attributes))for(let s of this.attributes)s.name!="rel"&&l.setAttribute(s.name,s.value);this.parentNode.insertBefore(l,this)}this.parentNode.removeChild(this)}else(()=>{let r=new MutationObserver(()=>{n=document.getElementById(t),n&&(r.disconnect(),this.replaceWith(this))});r.observe(globalThis.document,{subtree:!0,childList:!0})})()}};customElements.get("simply-render")||customElements.define("simply-render",V);globalThis.simply||(globalThis.simply={});Object.assign(globalThis.simply,{bind:ce,flow:K,state:F});var De=globalThis.simply;})();
